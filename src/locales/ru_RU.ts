...
export const ru_RU: LocaleDefinition = {
  ...
  emailDomains: [
    'gmail.com', 'mail.ru', 'yandex.ru', 'rambler.ru', 'yahoo.com',
    'outlook.com', 'hotmail.com', 'bk.ru', 'list.ru', 'inbox.ru'
  ],

  companyNames: [
    'Газпром', 'Роснефть', 'Лукойл', 'Сбербанк', 'ВТБ',
    'Российские железные дороги', 'Норникель', 'Новатэк', 'Татнефть',
    'Аэрофлот', 'Яндекс', 'Mail.ru Group', 'Wildberries', 'Ozon',
    'МТС', 'Билайн', 'МегаФон', 'Ростелеком', 'Алроса'
  ],

  industries: [
    'Технологии', 'Финансы', 'Здравоохранение', 'Образование', 'Розничная торговля',
    'Производство', 'Медиа', 'Телекоммуникации', 'Энергетика', 'Транспорт',
    'Недвижимость', 'Консалтинг', 'Гостиницы', 'Автомобилестроение', 'Аэрокосмос'
  ],

  catchPhrases: [
    'Инновации для будущего', 'Ваш успех - наше дело', 'Строим будущее вместе',
    'Качество и надежность', 'Превосходство и приверженность', 'Устойчивые решения',
    'Создаем ценность', 'Ваш надежный партнер', 'Ведущие перемены'
  ]
};